...
config.background = {
  {
    source = {
      ...
      -- File = wezterm.config_dir .. "/wallpapers/l_1_0.jpg",
      -- File = wezterm.config_dir .. "/wallpapers/l_1_1.jpg",
      -- File = wezterm.config_dir .. "/wallpapers/l_1_2.jpg",
      File = wezterm.config_dir .. "/wallpapers/cotn_2.png",
      -- File = wezterm.config_dir .. "/wallpapers/f_1.jpg",
      -- File = wezterm.config_dir .. "/wallpapers/2_1.png",
    },
    -- hsb = { brightness = 0.02 },
    -- hsb = { brightness = 0.03 },
    -- hsb = { brightness = 0.04 },
