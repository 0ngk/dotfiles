...
require("config.fsharp.runtime").setup()
...
keymap("n", "W", ":noautocmd w<cr>", { silent = true, desc = "Save without autocmds" })
keymap("n", "<leader>w", smart_close, { silent = true, desc = "Smart Close Window or Buffer" })
keymap("n", "<leader>q", ":qa<cr>", { silent = true, desc = "Close all the windows" })
...
keymap("n", "<lt>", "<cmd>tabnew<cr>", { silent = true, desc = "Tabpage New (S-,)" })
...
end, { silent = true, desc = "Window Buffer Remove" })
keymap("n", "<leader>bD", function()
...
-- Fern
keymap("n", "<Leader>r", "<cmd>Fern . -reveal=% -drawer<cr>", { silent = true })
keymap("n", "<Leader>e", "<cmd>Fern . -reveal=%<cr>", { silent = true })

-- LSP keymaps (using snacks.picker)
keymap("n", "<Tab>", function()
  if vim.bo.filetype == "fsharp" then
    require("config.fsharp.definition").go_to_definition_with_fallback()
    return
  end
